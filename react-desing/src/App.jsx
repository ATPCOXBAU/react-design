...
export function Products() {
  return(
      <div className="flex flex-wrap justify-center space-x-2 mr-0 ml-0 md:mr-6 md:ml-6 ">
        <EcommerceCard />
        <EcommerceCard />
        <EcommerceCard />
        <EcommerceCard />
...
export function EcommerceCard() {
  return (
    <Card className="w-40 bg-white mt-3 mb-3  md:w-72  hover:shadow-2xl delay-100  ">
      <CardHeader shadow={true} floated={false} >
      <div className="bg-indigo-300 h-40 md:h-80 ">
      ...
      <CardBody>
        <div className="mb-2 flex items-center justify-between bg-blue-gray-50 rounded">
