...
export function Products() {
  return(
      <div className="flex flex-wrap justify-center gap-2 space-x-2 mr-0 ml-0 md:mr-40 md:ml-40 ">
        <EcommerceCard />
        <EcommerceCard />
        <EcommerceCard />
        <EcommerceCard />
...
export function EcommerceCard() {
  return (
    <Card className="w-40 bg-white mt-7 mb-7  max-h-max md:w-80   hover:shadow-2xl delay-100  ">
      ...
      <CardBody>
        <div className=" flex flex-wrap items-center justify-between rounded h-fit   ">
